...
<section id="wrapper">
    <div class="container">
        ...
        <div id="content-wrapper">
            ...
            <section id="content" style="box-shadow: 2px 2px 8px 0 rgba(0,0,0,.2); background: #fff;"
                     class="page-content">
                <div class="container">
                    <section class="page_content">
                        <div class="col-xs-12" style="padding-top: 5%">
                            ...
                            <table class="table table-striped table-bordered table-labeled hidden-xs-down">
                                ...
                                <tr>
                                    <td><br>
                                        <p>{$orderDetails->date_add|date_format:"%d/%m/%Y"}</p></td>
                                    <td><span class="label label-pill dark"
                                              style="background-color:#32CD32">{l s='Payment accepted'}</span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="col-xs-12" style="display: inline-block">
                                ...
                                <table id="order-products" class="table table-bordered">
                                    ...
                                    <tr class="item">
                                        ...
                                        <td colspan="1">
                                            <p>{number_format($orderDetails->total_products_wt,2,'.','')}</p>
                                        </td>
                                    </tr>
                                    <tr class="item">
                                        ...
                                        <td colspan="1">
                                            <p>{number_format($orderDetails->total_discounts,2,'.','')}</p></td>
                                    </tr>
                                    <tr class="item">
                                        <td colspan="4"><p
                                        ...
                                        <td colspan="1">
                                            <p>{number_format($orderDetails->total_shipping,2,'.','')}</p></td>
                                    </tr>
                                    <tr class="item">
                                        <td colspan="4"><p
                                                style="float: right">{l s="Total"}</p></td>
                                        <td colspan="1">
                                            <p>{number_format($orderDetails->total_paid,2,'.','')}</p></td>
                                    </tr>
                                    </tfoot>
                                    <tbody>
                                    ...
                                    <tr class="ap-orderlines-capture">
                                        ...
                                        <td><p>{number_format($product.unit_price_tax_incl,2,'.','')}</p>
                                        </td>
                                        <td><p>{number_format($product.total_price_tax_incl,2,'.','')}</p>
                                        </td>
                                    </tr>
                                    {/foreach}
                                    </tbody>
