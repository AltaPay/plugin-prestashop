...
require_once ALTAPAY_API_ROOT . 'ALTAPAY_API_ROOT' . DIRECTORY_SEPARATOR . 'response'. DIRECTORY_SEPARATOR .'AltapayAbstractPaymentResponse.class.php';

class AltapayUpdateOrderResponse extends AltapayAbstractPaymentResponse
{
    /**
     * AltapayUpdateOrderResponse constructor.
