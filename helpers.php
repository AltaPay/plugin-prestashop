...
/**
 * Get terminal id based on terminal remote name and shop id
 *
...
{
    $sql = 'SELECT id_terminal, shop_id FROM `' . _DB_PREFIX_ . 'altapay_terminals` WHERE `remote_name`="' . $terminalRemoteName . '" AND `shop_id` = "' . $shop_id . '"';
